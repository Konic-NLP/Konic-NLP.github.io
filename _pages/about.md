...
- <img src=https://github.com/Konic-NLP/Konic-NLP.github.io/blob/master/images/android-chrome-512x512.png  width="5%" height="5%"></img> [**UMR-writer**](http://umr-tool.cs.brandeis.edu/): An annotation tool for Semantic Roles Labeling with Uniform Meaning Representation. ![commit](https://img.shields.io/github/last-commit/jinzhao3611/umr-annotation-tool/master)


- <img src=https://github.com/Konic-NLP/Konic-NLP.github.io/blob/master/images/Snipaste_2022-09-04_14-02-44.png  width="20%" height="20%"></img> [**Termbox**](http://termbox.lingosail.com/): A term-extraction and translation tool for Computer-Aided Translation.
